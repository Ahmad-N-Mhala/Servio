...
<head>
    <meta charset="utf-8">
    <title>Bill #<?php echo e($order->id); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1><?php echo e($tenant->name ?? 'RestaurFy'); ?></h1>
        ...
        <div class="bill-info">
            <div class="bill-info-left">
                <div class="info-group">
                    ...
                    <div class="info-value"><?php echo e($order->id); ?></div>
                </div>
                ...
                <?php if($order->table): ?>
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo e($order->table->table_number); ?></div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bill-info-right">
                ...
                <?php if($order->completed_at): ?>
                    <div class="info-group">
                        ...
                        <div class="info-value"><?php echo e($order->completed_at->format('d M Y, h:i A')); ?></div>
                    </div>
                <?php endif; ?>
        ...
        <?php if($order->points_earned > 0): ?>
            <div class="points-earned">
                🎉 You earned <?php echo e($order->points_earned); ?> loyalty points with this order!
            </div>
        <?php endif; ?>

        <div class="footer">
            <p>Thank you for your business!</p>
            <p><?php echo e($tenant->name ?? 'RestaurFy'); ?></p>
        </div>
    </div>
</body>
