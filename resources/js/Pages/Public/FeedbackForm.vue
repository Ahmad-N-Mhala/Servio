            ...
            <div class="p-8 pb-10">
                ...
                >
                    ...
                    <div v-if="!submitted" key="form">
                        <h2 class="text-xl font-bold text-gray-800 text-center mb-8 font-heading">How was your experience?</h2>
                        ...
                        <div class="flex justify-center gap-3 mb-10 group">
                            ...
                            >
                                <svg 
                                    class="w-10 h-10 transition-colors duration-200 drop-shadow-sm"
                                    :class="(hoverRating || form.rating) >= star ? 'text-yellow-400 fill-yellow-400' : 'text-gray-200 fill-gray-50'"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    stroke-width="1.5"
                                >
