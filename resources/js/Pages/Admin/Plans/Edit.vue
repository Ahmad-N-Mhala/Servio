    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="font-bold text-2xl text-slate-800 dark:text-slate-100 leading-tight">Edit Subscription Plan</h2>
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="space-y-8">
                    <!-- General Details -->
                    <Card title="General Details" subtitle="Edit the core information and bilingual names for this plan.">
...
const form = useForm({
    ...
    max_restaurants: props.plan.max_restaurants as number | null,
    max_users: props.plan.max_users as number | null,
    max_orders_per_month: props.plan.max_orders_per_month as number | null,
    order: props.plan.order || 0,
    is_active: !!props.plan.is_active,
    features: props.plan.features || [] as string[],
    enabled_features: props.plan.enabled_features || [] as string[],
});

const isSlugModified = ref(true); // Default to true in Edit form so it doesn't auto-overwrite existing slug
...
const lastLimitFeatures = ref({
    max_restaurants: getLimitFeatureString('max_restaurants', form.max_restaurants),
    max_users: getLimitFeatureString('max_users', form.max_users),
    max_orders_per_month: getLimitFeatureString('max_orders_per_month', form.max_orders_per_month)
});
