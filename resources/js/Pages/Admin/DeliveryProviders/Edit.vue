                    ...
                    <form @submit.prevent="submit">
                        <div class="p-8 space-y-6">
                            ...
                            <div>
                                ...
                                <!-- Logo Preview -->
                                <div v-if="form.logo_url" class="mt-6 p-4 bg-gray-50 rounded-lg">
                                    <p class="text-sm font-medium text-gray-700 mb-2">Logo Preview:</p>
                                    <div class="h-20 w-20 bg-white rounded-lg shadow-sm flex items-center justify-center p-2">
                                        <img :src="form.logo_url" :alt="form.name" class="max-h-full max-w-full object-contain" />
                                    </div>
                                </div>
                            </div>
...
const form = ref({
    ...
    requires_api_key: props.provider.requires_api_key,
    requires_api_secret: props.provider.requires_api_secret,
    requires_store_id: props.provider.requires_store_id,
    requires_webhook_secret: props.provider.requires_webhook_secret,
...
const submit = () => {
    ...
    const url = route('admin.delivery-providers.update', props.provider.id);
    router.post(url, {
        ...form.value,
        _method: 'PUT',
    }, {
