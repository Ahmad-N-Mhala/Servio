                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    >
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500">Card</p>
...
const columns = [
    ...
    { key: 'table', label: 'Customer / Table', sortable: false },
    { key: 'payment_method', label: 'Method', sortable: true },
    { key: 'waiter', label: 'Waiter', sortable: false },
    { key: 'total', label: 'Amount', sortable: true, align: 'right' as const },
];
