<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 gradient-mesh">
        <!-- Sidebar -->
        <aside 
            class="fixed inset-y-0 left-0 z-50 w-64 glass-sidebar shadow-lifted transform transition-all duration-300 ease-in-out lg:translate-x-0" 
            :class="{ '-translate-x-full': !isSidebarOpen }"
        >
            <!-- Logo Section -->
            <div class="flex items-center justify-center h-16 px-6 border-b border-gray-100/50 dark:border-gray-700/50">
                <Logo />
            </div>
            ...
            <nav class="mt-6 px-3 space-y-1">
                <!-- Main Menu Section -->
                <div class="mb-6">
                    <p class="px-4 mb-3 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                        Main Menu
                    </p>
                ...
                <div class="mb-6">
                    ...
                    <Link 
                        ...
                        :class="[
                            'group flex items-center px-4 py-3 rounded-xl transition-all duration-200 menu-item-hover',
                            $page.url.includes('/loyalty/earning-methods') 
                                ? 'menu-item-active text-primary font-semibold' 
                                : 'text-gray-600 dark:text-gray-300 hover:text-primary'
                        ]"
                    >
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100/50 dark:border-gray-700/50">
                <div class="flex items-center gap-3 px-3 py-2 rounded-xl bg-gradient-to-r from-primary/5 to-primary/10">
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-900 dark:text-white">Pro Plan</p>
        ...
        <div class="lg:ml-64 min-h-screen flex flex-col">
            ...
            <header class="glass sticky top-0 z-40 h-16 flex items-center justify-between px-6 lg:px-8 border-b border-gray-100/50 dark:border-gray-700/50">
                ...
                <div class="flex items-center ml-auto space-x-3">
                    <!-- Search Button -->
                    <button class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Notifications -->
                    <button class="relative p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-all duration-200 group">
