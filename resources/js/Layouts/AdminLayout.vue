                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-semibold">{{ currentLocale === 'ar' ? 'العربية' : 'English' }}</span>
                            </div>
                                ...
                                >
                                    ...
                                    <div class="w-6 h-6 rounded-full overflow-hidden border-2 border-gray-200 flex-shrink-0">
                                        <svg class="w-full h-full" viewBox="0 0 60 30" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g clip-path="url(#s3)"><path d="M0,0 v30 h60 v-30 z" fill="#012169"/><path d="M0,0 L60,30 M60,0 L0,30" stroke="#fff" stroke-width="6"/><path d="M0,0 L60,30 M60,0 L0,30" clip-path="url(#t3)" stroke="#C8102E" stroke-width="4"/><path d="M30,0 v30 M0,15 h60" stroke="#fff" stroke-width="10"/><path d="M30,0 v30 M0,15 h60" stroke="#C8102E" stroke-width="6"/></g>
                                        </svg>
                                    </div>
