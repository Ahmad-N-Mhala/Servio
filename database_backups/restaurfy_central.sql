...
\restrict cmaPpDQecsldVz6cbdw1sGCNhyd4vStUazyVmJTWLqJzFsSdvtG5xgjUE05lOo6
...
CREATE TABLE public.restaurants (
    ...
    email_balance integer DEFAULT 0 NOT NULL
);
...
--
-- Data for Name: communication_bundles; Type: TABLE DATA; Schema: public; Owner: ahmadmhala
--

COPY public.communication_bundles (id, name, type, quantity, price, currency, is_active, created_at, updated_at) FROM stdin;
1	Starter SMS Pack	sms	100	50.00	AED	t	2025-12-12 21:23:46	2025-12-12 21:23:46
2	Pro SMS Pack	sms	500	200.00	AED	t	2025-12-12 21:23:46	2025-12-12 21:23:46
3	Starter Email Pack	email	1000	100.00	AED	t	2025-12-12 21:23:46	2025-12-12 21:23:46
4	Pro Email Pack	email	5000	400.00	AED	t	2025-12-12 21:23:46	2025-12-12 21:23:46
\.


--
-- Data for Name: communication_logs; Type: TABLE DATA; Schema: public; Owner: ahmadmhala
--

COPY public.communication_logs (id, type, recipient, message, status, cost, error_message, created_at, updated_at, communication_template_id) FROM stdin;
\.


--
-- Data for Name: communication_templates; Type: TABLE DATA; Schema: public; Owner: ahmadmhala
--

COPY public.communication_templates (id, restaurant_id, name, trigger_event, subject, content, conditions, is_active, created_at, updated_at, channels, timing_type, timing_days, timing_time) FROM stdin;
\.
...
4	demo.localhost	demo	2025-12-12 21:09:59	2025-12-12 21:09:59
\.
...
20	2025_12_06_075449_create_earning_methods_table	2
21	2025_12_06_081121_add_conditions_to_earning_methods_table	2
22	2025_12_06_082447_add_currency_amount_to_earning_methods_table	2
23	2025_12_06_113916_create_restaurant_tables_table	2
24	2025_12_06_113922_add_type_and_table_id_to_orders_table	2
25	2025_12_06_131636_create_password_reset_tokens_table	2
26	2025_12_06_164500_add_payment_status_to_orders_table	2
27	2025_12_14_000000_create_communication_features_tables	2
28	2025_12_14_100000_create_communication_templates_table	3
29	2025_12_14_103000_update_templates_channels	4
30	2025_12_14_110000_add_timing_to_templates	5
\.
...
COPY public.restaurants (id, name, slug, description, phone, email, address, city, country, currency, locale, settings, created_at, updated_at, sms_balance, email_balance) FROM stdin;
\.
...
demo	demo	3	active	2026-12-12 21:09:59	[]	2025-12-12 21:09:59	2025-12-12 21:09:59
\.
...
--
-- Name: communication_bundles_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ahmadmhala
--

SELECT pg_catalog.setval('public.communication_bundles_id_seq', 4, true);


--
-- Name: communication_logs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ahmadmhala
--
...
--
-- Name: communication_templates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ahmadmhala
--
...
\unrestrict cmaPpDQecsldVz6cbdw1sGCNhyd4vStUazyVmJTWLqJzFsSdvtG5xgjUE05lOo6
